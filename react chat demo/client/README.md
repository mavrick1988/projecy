...
type and enter "npm i react-scripts", then type "npm i socket.io-client"and enter. type and enter "npm start" and your browser should open automatically.
...
and that's it, i put my name as the default on the chat system since this just a sample program.
